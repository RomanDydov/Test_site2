...
gulp.task('scripts', ['common-js'], function() {
	return gulp.src([
		...
		//'app/libs/mmenu/js/jquery.mmenu.all.min.js', // Мега меню
		//'app/libs/Magnific-Popup/jquery.magnific-popup.min.js',
		//'app/libs/owl.carousel/owl.carousel.min.js',
		//'app/libs/PageScroll2id/jquery.malihu.PageScroll2id.js', // Плавный скролл  
		//'app/libs/fotorama/fotorama.js', // Слайдер
		...
		//'app/libs/mixitup/mixitup.min.js', // Filter content
...
gulp.task('watch', ['pug', 'sass', 'scripts', 'browser-sync'], function() {
	...
	gulp.watch(['libs/**/*.js', 'app/js/common/common.js'], ['scripts']);
